...
public class StarScore03 : MonoBehaviour
{
    ...
    IEnumerator StarScoreOn()
    {
        while (true)
        {
            ...
            {
                if (GameObject.Find("Player").GetComponent<Player03>().howMuchItem >= 5)
                {
                    howMuchStarScore = 3;
                ...
                else if (GameObject.Find("Player").GetComponent<Player03>().howMuchItem >= 3)
                {
                    howMuchStarScore = 2;
                ...
                else if (GameObject.Find("Player").GetComponent<Player03>().howMuchItem >= 1)
                {
                    howMuchStarScore = 1;
