...
public class CameraMoving03 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Debug.Log(PlayerPrefs.GetString("schoolName"));
        //schoolName.text = PlayerPrefs.GetString("schoolName") + " 고등학교 제 23회 개교기념일 행사";

        schoolName.text = userData.schoolName + " 고등학교 제 23회 개교기념일 행사";
    ...
    IEnumerator LightIntensity()
    {
        while (true)
        {
            ...
            {
                mainLight.intensity = mainLight.intensity - 0.05f;
    ...
    IEnumerator ScreenChange_2() //퍼즐 게임 종료
    {
        while (true)
        {
            ...
            if (isPuzzleGameStart == false)
            {
                ...
                GetComponent<Conversation03_After>().playerHaveItem = GameObject.FindWithTag("Player").GetComponent<Player03>().howMuchItem;
