...
public class StarScore04 : MonoBehaviour
{
    ...
    IEnumerator StarScoreOn()
    {
        while (true)
        {
            ...
            {
                if (GameObject.Find("r_Player").GetComponent<Player04>().howMuchItem >= 10)
                {
                    howMuchStarScore = 3;
                ...
                else if (GameObject.Find("r_Player").GetComponent<Player04>().howMuchItem >= 5)
                {
                    howMuchStarScore = 2;
                ...
                else if (GameObject.Find("r_Player").GetComponent<Player04>().howMuchItem >= 1)
                {
                    howMuchStarScore = 1;
